...
//    if (angleUnitCircle.x < 0.001 && angleUnitCircle.y > -0.001)
//    {
...
////--------------------------------------------------------------------------------------Фабрика
//
//Vector2f CreatorPlatform::SomeCollisionWithBall(Vector2f angleUnitCircle, Ball& ball)
//{
//    Platform* platform = this->FactoryMethod();
//
//    Vector2f result = platform->CollisionWithBall(angleUnitCircle, ball);
//
//    delete platform;
//    return  result;
//}
